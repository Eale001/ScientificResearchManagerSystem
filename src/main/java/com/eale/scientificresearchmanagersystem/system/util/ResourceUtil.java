...
//    }
//    //hrm
//    public static final HrmUser getSessionHrmUserName(){
//        HttpSession session=ContextHolderUtils.getSession();
//        if (ClientManager.getInstance().getClient(session.getId())!=null){
//            return ClientManager.getInstance().getClient(session.getId()).getHrmUser();
//        }else {
//            HrmUser u=(HrmUser) session.getAttribute(ResourceUtil.LOCAL_CLINET_USER);
//            Client client=new Client();
//            client.setIp("");
//            client.setLogindatetime(new Date());
//            client.setHrmUser(u);
